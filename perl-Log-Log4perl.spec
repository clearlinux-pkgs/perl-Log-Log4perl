...
Version  : 1.50
Release  : 17
URL      : https://cpan.metacpan.org/authors/id/E/ET/ETJ/Log-Log4perl-1.50.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/E/ET/ETJ/Log-Log4perl-1.50.tar.gz
...
%prep
%setup -q -n Log-Log4perl-1.50
cd %{_builddir}
tar xf %{_sourcedir}/liblog-log4perl-perl_1.49-1.debian.tar.xz
cd %{_builddir}/Log-Log4perl-1.50
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Log-Log4perl-1.50/deblicense/
...
cp %{_builddir}/Log-Log4perl-1.50/LICENSE %{buildroot}/usr/share/package-licenses/perl-Log-Log4perl/3c593274c224f71d76a246007a4fae4f2cde1ed2
