...
Source0  : https://cpan.metacpan.org/authors/id/E/ET/ETJ/Log-Log4perl-1.56.tar.gz
...
%prep
%setup -q -n Log-Log4perl-1.56
cd %{_builddir}
tar xf %{_sourcedir}/liblog-log4perl-perl_1.49-1.debian.tar.xz
cd %{_builddir}/Log-Log4perl-1.56
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Log-Log4perl-1.56/deblicense/
